...
interface DefaultsUtils {
    companion object {
        const val DATE_FORMAT = "dd/MM/yyyy"
        const val DATE_FORMAT2 = "dd-MM-yyyy"
        const val DATE_FORMAT3 = "HH:mm dd/MM/yyyy"
        const val DATE_FORMAT_TIME_ZONE = "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'"
        const val DATE_FORMAT_TIME_ZONE2 = "yyyy-MM-dd'T'HH:mm:ssZ"
